...
import { User, UserToken } from './auth.models';

// Register action
export const Register = createAction('[Authentication] Register', props<{ email: string, username: string, password: string }>());
export const RegisterSuccess = createAction('[Authentication] Register Success', props<{ userToken: UserToken }>());
...
export const loginSuccess = createAction('[Authentication] Login Success', props<{ userToken: UserToken }>());
